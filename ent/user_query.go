...
type UserQuery struct {
	...
	withTodos      *TempleQuery
	modifiers      []func(*sql.Selector)
	loadTotal      []func(context.Context, []*User) error
	withNamedTodos map[string]*TempleQuery
...
func (uq *UserQuery) QueryTodos() *TempleQuery {
	query := (&TempleClient{config: uq.config}).Query()
...
func (uq *UserQuery) WithTodos(opts ...func(*TempleQuery)) *UserQuery {
	query := (&TempleClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withTodos; query != nil {
		if err := uq.loadTodos(ctx, query, nodes,
			func(n *User) { n.Edges.Todos = []*Temple{} },
			func(n *User, e *Temple) { n.Edges.Todos = append(n.Edges.Todos, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range uq.withNamedTodos {
		if err := uq.loadTodos(ctx, query, nodes,
			...
			func(n *User, e *Temple) { n.appendNamedTodos(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (uq *UserQuery) loadTodos(ctx context.Context, query *TempleQuery, nodes []*User, init func(*User), assign func(*User, *Temple)) error {
...
func (uq *UserQuery) WithNamedTodos(name string, opts ...func(*TempleQuery)) *UserQuery {
	query := (&TempleClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if uq.withNamedTodos == nil {
		uq.withNamedTodos = make(map[string]*TempleQuery)
	}
