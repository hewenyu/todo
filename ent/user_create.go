...
func (uc *UserCreate) SetDeleteAt(ua user.DeleteAt) *UserCreate {
	uc.mutation.SetDeleteAt(ua)
	return uc
}

// SetNillableDeleteAt sets the "delete_at" field if the given value is not nil.
func (uc *UserCreate) SetNillableDeleteAt(ua *user.DeleteAt) *UserCreate {
	if ua != nil {
		uc.SetDeleteAt(*ua)
	}
	return uc
...
func (uc *UserCreate) AddTodoIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddTodoIDs(ids...)
	return uc
}

// AddTodos adds the "todos" edges to the Temple entity.
func (uc *UserCreate) AddTodos(t ...*Temple) *UserCreate {
...
func (uc *UserCreate) check() error {
	...
	if v, ok := uc.mutation.DeleteAt(); ok {
